...
--
-- Host: localhost:3306
-- Generation Time: Nov 14, 2019 at 10:27 AM
...
INSERT INTO `bidang` (`idbdng`, `namabdng`, `jbtnbdng`, `gbrbdng`) VALUES
(1, 'Panji Sukma Nugraha', 'Wakil Sekretaris', 'WhatsApp_Image_2019-10-19_at_16_45_50.jpeg');
...
(1, 'Muhammad Irfan Permana', 'irfanthejoelax@gmail.com', 'f455f5a8421d755049228c4a700c1dea');
...
--
ALTER TABLE `berita`
  MODIFY `idbrt` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `bidang`
--
ALTER TABLE `bidang`
  MODIFY `idbdng` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `kontak`
  MODIFY `idkntk` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

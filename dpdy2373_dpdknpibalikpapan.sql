...
--
-- Host: localhost:3306
-- Generation Time: Oct 23, 2019 at 09:20 AM
...
--
-- Database: `dpdy2373_dpdknpibalikpapan`
--
...
(10, 'Adi Kembali Pimpin KNPI Balikpapan Utara 2019-2022', 'adi-kembali-pimpin-knpi-balikpapan-utara-2019-2022', 'balut_knpi--.jpg', '<div xss=removed><span xss=removed>BALIKPAPAN, KABARKALTIM.CO.ID-Fauzi Adi Firmansyah yang akrab disama Adi, kembali terpilih sebagai Ketua KNPI  Balikpapan Utara periode 2019-2022, dalam musyawarah kecamatan DPD KNPI se-Kota Balikpapan, Minggu (14/7/2019) di gedung KNPI Balikpapan. </span></div>\r\n\r\n<div xss=removed> </div>\r\n\r\n<div xss=removed><span xss=removed>Adi yang merupakan adik kandung Ketua DPRD Balikpapan Abdulloh SSos, mendapatkan 45 dukungan dari organisasi kemasyarakatan pemuda (OKP). Kinerja yang ditunjukkan Adi selama periode sebelumnya, sangat positif, dan diharapkan terus membawa KNPI Balikpapan Utara semakin maju dan sejahtera. </span></div>\r\n\r\n<div xss=removed><span xss=removed><img alt=\"\" class=\"img-fluid\" src=\"/asset/vendor/fileman/Uploads/Images/balut_knpi1_ - Copy 1.jpg\" xss=removed></span></div>\r\n\r\n<div xss=removed> </div>\r\n\r\n<div xss=removed>\r\n<div xss=removed><span xss=removed>\"Terima kasih dukungan dan kepercayaan dari rekan-rekan semua, amanah ini akan saya jalankan sebaik-baiknya. Membawa KNPI Balikpapan Utara, lebih maju, aktif dengan program-program positif bagi masyarakat luas,\" ungkap Adi usai dirinya terpilih kembali. </span></div>\r\n\r\n<div xss=removed> </div>\r\n\r\n<div xss=removed><span xss=removed>Bahkan dalam sambutannya setelah kembali terpilih, Adi mengharapkan perhatian dari DPD KNPI Balikpapan untuk KNPI Balikpapan Utara. \"Harus diperhatikan jika ada kegiatan-kegiatan di DPD KNPI Balikpapan,\" harap Adi. (sinta)</span></div>\r\n\r\n<div xss=removed> </div>\r\n\r\n<div xss=removed><span xss=removed>sumber : </span><a href=\"http://www.kabarkaltim.co.id/2019/07/adi-kembali-pimpin-knpi-balikpapan.html?m=1\">http://www.kabarkaltim.co.id/2019/07/adi-kembali-pimpin-knpi-balikpapan.html?m=1</a></div>\r\n</div>\r\n', 0);
...
(28, 'PC. PERGERAKAN MAHASISWA  ISLAM INDONESIA  KOTA BALIKPAPAN', 'OKP', 'Moh Faily', NULL, 'Muhammad Said Abdil', NULL, 'Muhammad Khayrul Anam', NULL, NULL),
...
(1, 'Andi Achmad Mutawally', 'Ketua', 'WhatsApp_Image_2019-07-17_at_10_23_32.jpeg'),

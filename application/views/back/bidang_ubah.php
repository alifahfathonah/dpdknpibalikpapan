<?php $this->load->view('back/layouts/header') ?>
        ...
        <div class="container-fluid">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="<?= site_url('bidang/run/update/'.$bidang->idbdng) ?>" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group row">
                                    <label for="txt_nama" class="col-sm-2 col-form-label">Nama</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control form-control-sm" id="txt_nama" name="txt_nama" value="<?= $bidang->namabdng ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <br>
                                        <img src="<?= base_url('asset/bidang/'.$bidang->gbrbdng) ?>" alt="<?= $bidang->gbrbdng ?>" width="100" height="125">
                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <div class="col-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control form-control-sm" id="txt_jbtn" name="txt_jbtn" value="<?= $bidang->jbtnbdng ?>">
                                    </div>
                                </div>
                            </div>
                        </div>

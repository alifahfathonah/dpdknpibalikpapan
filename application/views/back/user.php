            ...
            <div class="card shadow mb-4">
                <div class="card-header bg-info">
                    <h6 class="m-0 font-weight-bold text-white">
                        Manajemen Data User
                        <a href="<?= site_url('admin/view/user-tambah') ?>" class="btn btn-sm btn-warning float-right"><i class="fas fa-plus fa-sm"></i> &nbsp; Tambah</a>
                    </h6>
                </div>
                <div class="card-body">
...
<script>
    ...
    function deleteData(id) {
        if (confirm("Apakah Anda Yakin Ingin Menghapus Data ?")) {
            $.ajax({
                url: "<?php echo site_url('user/run/delete/') ?>"+id,
                type: "POST",
